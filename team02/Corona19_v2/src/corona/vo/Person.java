...
public class Person {
	...
	public Person(int ssn, String name, String address1, String address2, int age, String gender, int infecter,
			String test_condition, String isolation, String country) {
		super();
		this.ssn = ssn;
		this.name = name;
